...
assert '~/tools/clarity' not in readme, "README still references the stale pre-release checkout path"
assert '/Users/you/tools/clarity' not in readme, "README still references the stale pre-release checkout path"
assert '$HOME/tools/clarity' not in readme, "README still references the stale pre-release checkout path"
